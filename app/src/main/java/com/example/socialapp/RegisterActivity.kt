...
class RegisterActivity : AppCompatActivity(),
    ...
    private lateinit var memberNameField: EditText
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        memberNameField = findViewById(R.id.editText)
        memberNameField.setOnEditorActionListener(this)

        SocialApp.networkMessageHandler = this
        SocialApp.activityTracker = ActivityTracker.Register
    }
