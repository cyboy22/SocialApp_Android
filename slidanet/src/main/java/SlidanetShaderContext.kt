...
internal data class SlidanetShaderContext(val contentFilter: SlidanetContentFilterType = SlidanetContentFilterType.Default,
                                          ...
                                          val boxBeginX: Float = 0.0f,
                                          val boxBeginY: Float = 0.0f,
                                          val boxEndX: Float = 0.0f,
                                          val boxEndY: Float = 0.0f,
                                          val maskRedValue: Float = 0.0f,
                                          val maskGreenValue: Float = 0.0f,
                                          val maskBlueValue: Float = 0.0f,
                                          val maskAlphaValue: Float = 1.0f,
